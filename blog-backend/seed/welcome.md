...
This is your first post. Everything on this site — the hero, about, experience,
projects, skills, education and contact sections, plus the colors, fonts, this
blog, and the links feed — is editable from the **/admin** panel. No code, no
...
Sign in at `/admin`, delete this post, and make the site your own.
